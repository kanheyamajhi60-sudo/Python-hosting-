...
# --- [ᴄᴏɴꜰɪɢᴜʀᴀᴛɪᴏɴ] ---
TOKEN = os.environ.get('BOT_TOKEN','8991283184:AAHKA9vYljZ4y7wrCcHPk3hStnmdslvuApQ')

ADMIN_IDS = [
    int(os.environ.get('ADMIN_ID_1', '8417161342')),
...
PRIMARY_ADMIN_ID = ADMIN_IDS[0] if ADMIN_IDS else 8417161342
ADMIN_USERNAME = "@OWNERHIMANSHU"
ADMIN_DISPLAY_NAME = "💞🇭 🇮 🇲 🇦 🇳 🇸 🇭 🇺 💞"

# 🔴 Channel Mandatory Settings
REQUIRED_CHANNEL = "https://t.me/+0ejomySp0rlhYmNl"
